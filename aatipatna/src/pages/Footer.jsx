                ...
                <div class="col-12 col-md-4 col-lg-3 col-xl-2">
                  <div class="widget">
                    ...
                    <ul class="list-unstyled">
                      <li class="mb-2">
                        <a href="#!" class="link-secondary text-decoration-none">Computer Basics</a>
                      </li>
                      <li class="mb-2">
                        <a href="#!" class="link-secondary text-decoration-none">DCA</a>
                      </li>
                      <li class="mb-2">
                        <a href="#!" class="link-secondary text-decoration-none">English Speaking</a>
                      </li>
                      <li class="mb-2">
                        <a href="#!" class="link-secondary text-decoration-none">Diploma</a>
                      </li>
                      <li class="mb-0">
                        <a href="#!" class="link-secondary text-decoration-none">Certification Courses</a>
                      </li>
                    </ul>
                  </div>
                </div>
              ...
              <div class="row gy-4 gy-md-0">
                <div class="col-xs-12 col-md-7 order-1 order-md-0">
                  ...
                  <div class="credits text-secondary text-center text-md-start mt-2 fs-7">
                    Built by <a href="https://bootstrapbrain.com/" class="link-secondary text-decoration-none">Md Arif Ali</a> with <span class="text-primary">&#9829;</span>
                  </div>
                </div>

                <div class="col-xs-12 col-md-5 order-0 order-md-1">
                  <ul class="nav justify-content-center justify-content-md-end" style={{bsnavlinkpaddingx:" .8rem"}}>
                    <li class="nav-item">
